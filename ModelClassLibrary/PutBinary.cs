...
{
    public class PutBinary
    {
        public PutBinary()
        {
            PutBinaryDetailsList = new List<PutBinaryDetails>();
            StatusList = new List<LookupMaster>();
        }

        public Int32 PutBinaryID { get; set; }
        ...
        public double CouponFall { get; set; }
        ...
        public Highcharts PutBinaryChart { get; set; }

        public List<PutBinaryDetails> PutBinaryDetailsList { get; set; }
    ...
    public class PutBinaryDetails
    {
        public Int32 PutBinaryDetailsID { get; set; }
        public Int32 PutBinaryID { get; set; }
